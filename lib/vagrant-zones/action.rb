...
module VagrantPlugins
	module ProviderZone
		module Action
			...
			autoload :ListSnapshots, action_root.join('create_zfs_snapshots')
			autoload :ListSnapshots, action_root.join('delete_zfs_snapshots')
			autoload :ListSnapshots, action_root.join('configure_zfs_snapshots')
