          ...
          datasets.each_with_index do |disk,index|
            ...
            zfssnapshots.reverse.each_with_index do |snapshot, snapindex|
              ...
              if snapindex == 0
                ...
                puts sprintf '%5s  %-*s  %4s  %4s  %4s  %5s', "#", maxlength, attributes[0], attributes[1], attributes[2], attributes[3], attributes[4]
              else
                puts sprintf '%5s  %-*s  %4s  %4s  %4s  %5s', snapindex - 1, maxlength ,attributes[0], attributes[1], attributes[2], attributes[3], attributes[4]
              end
              output = {}
            end
