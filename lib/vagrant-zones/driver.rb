             ...
             crons.each do |job|
              ...
              if options[:list]
                ...
                if options[:list] == 'all'
                  ...
                  puts hourly if  options[:frequency_rtn] == 'hourly' 
                  puts daily if options[:frequency_rtn] == 'daily' 
                  puts weekly if  options[:frequency_rtn] == 'weekly'
                  puts monthly if options[:frequency_rtn] == 'monthly' 
                end
