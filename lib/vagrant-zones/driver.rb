        ...
        when 'list'
          ...
          datasets.each_with_index do |disk,index|
            ...
            zfssnapshots.reverse.each_with_index do |snapshot, snapindex|
              ...
              if snapindex == 0
                puts sprintf '%4s  %6s  %10s  %7s  %8s  %10s', "#", attributes[1], attributes[2], attributes[3], attributes[4], attributes[0]
              else
                puts sprintf '%4s  %6s  %10s  %7s  %8s  %10s', snapindex - 1, attributes[1], attributes[2], attributes[3], attributes[4], attributes[0]
              end
              output = {}
