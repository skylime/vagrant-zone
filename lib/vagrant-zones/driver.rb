        ...
        when 'list'
          ...
          datasets.each_with_index do |disk,index|
            ...
            zfssnapshots.reverse.each_with_index do |snapshot, snapindex|
              ...
              if snapindex == 0
                puts sprintf '%5s  %5t  %10s  %8s  %5s    %5s', "#", attributes[0], attributes[1], attributes[2], attributes[3], attributes[4]
              else
                puts sprintf '%5s  %5t  %10s  %8s  %5s    %5s', snapindex - 1, attributes[0], attributes[1], attributes[2], attributes[3], attributes[4]
              end
              output = {}
            end
